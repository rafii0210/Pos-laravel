...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper"
            style="background-image: linear-gradient(to right, #ff8177 0%, #ff867a 0%, #ff8c7f 21%, #f99185 52%, #cf556c 78%, #b12a5b 100%) !important;">
    ...
    <script>
        ...
        $('.tambah-produk').click(function() {
            ...
            if (category_id == "") {
                alert('Mohon pilih kategori terlebih dahulu kawan!');
                return false;
            }
            if (produk_id == "") {
                alert('Mohon pilih Produk terlebih dahulu kawan!');
                return false;
            }
            ...
            let newRow = "";
            newRow += "<tr>";
            newRow += "<td>" + product_name + "<input type='hidden' name='product_id[]' value='" + produk_id +
                "'/></td>";
            newRow += "<td>Rp. " + product_price.toLocaleString('id-ID') + "</td>";
